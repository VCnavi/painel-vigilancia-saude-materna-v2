...
app_server <- function(input, output, session) {
  ...
  output$label_nivel_comp <- renderUI({
    div(
      ...
      if (input$nivel2 == "municipios_semelhantes") {
...
Silhueta e Calinski-Harabasz, o número de grupos adotado foi 3. </div>",
  ...
  observeEvent(input$nivel, {
    if (length(rv$input_nivel_anterior) == 1) {
      ...
      rv$input_nivel_anterior <- c(
        rv$input_nivel_anterior[length(rv$input_nivel_anterior)],
        input$nivel
      )
    }
  })
  ...
  observe({
    if (input$nivel == "municipal") {
      if (
        rv$input_nivel_anterior[length(rv$input_nivel_anterior) - 1] !=
          "municipal"
      ) {
  ...
  observeEvent(input$estado_municipio, {
    updateSelectizeInput(
      session,
      inputId = "municipio",
      choices = sort(municipios_choices$municipio[which(
        municipios_choices$uf == input$estado_municipio
      )]),
      server = FALSE
    )
  })
  ...
  observeEvent(input$estado_micro, {
    updateSelectizeInput(
      session,
      inputId = "micro",
      choices = sort(micro_r_saude_choices$r_saude[which(
        micro_r_saude_choices$uf == input$estado_micro
      )]),
      server = FALSE
    )
  })
  ...
  observeEvent(input$estado_macro, {
    updateSelectizeInput(
      session,
      inputId = "macro",
      choices = sort(macro_r_saude_choices$macro_r_saude[which(
        macro_r_saude_choices$uf == input$estado_macro
      )]),
      server = FALSE
    )
  })
  ...
  observeEvent(input$estado_municipio2, {
    updateSelectizeInput(
      ...
      inputId = "municipio2",
      choices = sort(municipios_choices$municipio[which(
        municipios_choices$uf == input$estado_municipio2
      )]),
      server = FALSE
    )
  })
  ...
  observeEvent(input$estado_micro2, {
    updateSelectizeInput(
      ...
      inputId = "micro2",
      choices = sort(micro_r_saude_choices$r_saude[which(
        micro_r_saude_choices$uf == input$estado_micro2
      )]),
      server = FALSE
    )
  })
  ...
  observeEvent(input$estado_macro2, {
    updateSelectizeInput(
      ...
      inputId = "macro2",
      choices = sort(macro_r_saude_choices$macro_r_saude[which(
        macro_r_saude_choices$uf == input$estado_macro2
      )]),
      server = FALSE
    )
  })
  ...
  observeEvent(input$bloco, {
    updateSelectizeInput(
      ...
      choices = tabela_indicadores$indicador[which(
        tabela_indicadores$bloco == input$bloco
      )],
      server = FALSE
    )
  ...
  observeEvent(c(input$tipo_do_indicador_blocos4_6_7, input$nivel), {
    if (input$tipo_do_indicador_blocos4_6_7 == "robson") {
      updateSelectizeInput(
        ...
        choices = c(
          tabela_indicadores$indicador[which(
            startsWith(
              tabela_indicadores$indicador,
              "Porcentagem de nascidos vivos"
            ) &
              tabela_indicadores$bloco == "bloco4"
          )],
          tabela_indicadores$indicador[which(
            startsWith(
              tabela_indicadores$indicador,
          ...
          tabela_indicadores$indicador[which(
            startsWith(tabela_indicadores$indicador, "Contribuição") &
              tabela_indicadores$bloco == "bloco4"
          )]
        ),
        server = FALSE
      ...
      if (input$nivel %in% c("municipal", "estadual")) {
        updateSelectizeInput(
          ...
          choices = trimws(tabela_indicadores$indicador[which(
            tabela_indicadores$bloco == "bloco4_deslocamento"
          )]),
          server = FALSE
        )
      } else {
        updateSelectizeInput(
          ...
          choices = trimws(tabela_indicadores$indicador[which(
            tabela_indicadores$bloco == "bloco4_deslocamento" &
              !base::startsWith(tabela_indicadores$indicador, "Medianas")
          )]),
          server = FALSE
        )
      }
      ...
      updateSelectizeInput(
        ...
        inputId = "indicador_blocos4_6_7",
        choices = trimws(tabela_indicadores$indicador[which(
          tabela_indicadores$bloco == "bloco6"
        )]),
        server = FALSE
      )
      ...
      updateSelectizeInput(
        ...
        inputId = "indicador_blocos4_6_7",
        choices = trimws(tabela_indicadores$indicador[which(
          tabela_indicadores$bloco == "bloco7_fetal"
        )]),
        server = FALSE
      )
      ...
      updateSelectizeInput(
        ...
        inputId = "indicador_blocos4_6_7",
        choices = trimws(tabela_indicadores$indicador[which(
          tabela_indicadores$bloco == "bloco7_perinatal"
        )]),
        server = FALSE
      )
      ...
      updateSelectizeInput(
        ...
        inputId = "indicador_blocos4_6_7",
        choices = trimws(tabela_indicadores$indicador[which(
          tabela_indicadores$bloco == "bloco7_neonatal"
        )]),
        server = FALSE
      )
      ...
      updateSelectizeInput(
        ...
        inputId = "indicador_blocos4_6_7",
        choices = trimws(tabela_indicadores$indicador[which(
          tabela_indicadores$bloco == "bloco7_morbidade_neonatal"
        )]),
        server = FALSE
      )
    }
    ...
    if (
      ...
      updateSelectizeInput(
        ...
        choices = c(
          ...
          "De 1000 a 1499 g" = "1000_a_1499",
          "De 1500 a 2499 g" = "1500_a_2499",
          "Menor que 2500 g" = "menos_2500"
        ),
        label = "Faixa de peso"
      )
      ...
      updateSelectizeInput(
        ...
        inputId = "indicador_uma_caixinha_adicional_bloco5",
        choices = c(
          "Menos que 28 semanas" = "menos_28",
          "De 28 a 32 semanas" = "28_a_32",
          "De 33 a 34 semans" = "33_a_34",
          "De 35 a 36 semanas" = "35_a_36",
  ...
  observeEvent(input$indicador_blocos4_6_7, {
    if (
      input$indicador_blocos4_6_7 %in%
        c(
      ...
      updateSelectizeInput(
        ...
        choices = c(
          "Geral" = "geral",
          "< 1000 g" = "menos1000",
          "1000 a 1499 g" = "1000_1499",
          "1500 a 2499 g" = "1500_2499",
          "Maior ou igual a 2500 g" = "mais2500"
        ),
        label = "Faixa de peso"
      )
    }
    ...
    if (
      ...
      updateSelectizeInput(
        ...
        inputId = "indicador_uma_caixinha_adicional_bloco7",
        choices = c(
          "No município de residência" = "municipio_res",
          "Fora do município de residência" = "fora_municipio_res",
          "Fora do município, mas na região de saúde estadual de residência" = "rsaude_res",
          "Fora da região de saúde estadual, mas na macrorregião de saúde estadual de residência" = "macro_rsaude_res",
          "Fora da macrorregião de saúde estadual, mas dentro da UF de residência" = "macro_rsaude_res",
    ...
    if (
      ...
      updateSelectizeInput(
        ...
        choices = c(
          ...
          "Medianas de deslocamento para partos ocorridos fora do município, mas na região de saúde estadual de residência" = "na_regiao",
          "Medianas de deslocamento para partos ocorridos fora da região de saúde estadual, mas na macrorregião de saúde estadual de residência" = "na_macrorregiao",
          "Medianas de deslocamento para partos ocorridos fora da macrorregião de saúde estadual, mas na UF de residência" = "fora_macrorregiao",
    ...
    if (
      ...
      #   session,
      #   inputId = "indicador_uma_caixinha_adicional_bloco7",
      #   choices = c("Na macrorregião de saúde estadual e em estabelecimento que tem pelo menos um leito de UTI" = "na_macro_com_uti",
      #               "Na macrorregião de saúde estadual, mas em estabelecimento que não tem leito de UTI" = "na_macro_sem_uti",
      #               "Fora da macrorregião de saúde estadual, mas em estabelecimento que tem pelo menos um leito de UTI" = "fora_macro_com_uti",
      #               "Fora da macrorregião de saúde estadual e em estabelecimento que não tem leito de UTI" = "fora_macro_sem_uti",
      #               "Na macrorregião de saúde estadual, mas sem informação sobre leito de UTI" = "na_macro_sem_inf",
      #               "Fora da macrorregião de saúde estadual, mas sem informação sobre leito de UTI" = "fora_macro_sem_inf"
      #               ),
