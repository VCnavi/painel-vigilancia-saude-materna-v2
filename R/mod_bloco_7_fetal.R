...
mod_bloco_7_fetal_ui <- function(id) {
  ns <- NS(id)
  tagList(
    tags$style(
      HTML(
      ...
      column(
        ...
        fluidRow(
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_fetal_num_obitos"),
              ...
              div(
                ...
                htmltools::tagList(
                  HTML("<b> Número de óbitos fetais&nbsp;</b>"),
                  shinyjs::hidden(
                    span(
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_fetal_num_obitos")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_fetal_taxa_de_mortalidade"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              div(
                ...
                style = glue::glue("height: 31%; padding: 0 10px; position: absolute; z-index: 2; color: transparent;"),
                htmltools::tagList(
                  HTML("<b> Taxa de mortalidade fetal por 1000 nascidos vivos&nbsp;</b>"),
                  shinyjs::hidden(
                    span(
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_fetal_taxa_de_mortalidade")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_fetal_distribuicao_momento"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              div(
                ...
                htmltools::tagList(
                  HTML("<b> Dentre os óbitos fetais selecionados,&nbsp;</b>"),
                  shinyjs::hidden(
                    span(
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_fetal_distribuicao_momento")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_fetal_distribuicao_peso"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_fetal_distribuicao_peso")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_fetal_principais"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_fetal_principais")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_fetal_evitaveis"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              div(
                ...
                style = glue::glue("height: 31%; padding: 0 10px; position: absolute; z-index: 2; color: transparent;"),
                htmltools::tagList(
                  HTML("<b> Porcentagem de óbitos fetais potencialmente evitáveis&nbsp;</b>"),
                  shinyjs::hidden(
                    span(
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_fetal_evitaveis")), proxy.height = "276px")
            )
          )
        )
      ),
            ...
            bs4Dash::bs4Card(
              ...
              fluidRow(
                column(
                  width = 6,
                  selectizeInput(
                    inputId = ns("input_num_obitos_momento"),
            ...
            bs4Dash::bs4Card(
              ...
              fluidRow(
                column(
                  width = 6,
                  selectizeInput(
                    inputId = ns("input_taxa_de_mortalidade_momento"),
                    label = span(class = "fonte-grande", "Momento do óbito"),
                    options = list(placeholder = "Selecione o momento do óbito"),
                    choices = c(
                      "Geral" = "todos",
          ...
          column(
            ...
            bs4Dash::bs4Card(
              ...
              div(
                ...
                HTML("<b class = 'fonte-muito-grande'> Distribuição percentual dos óbitos fetais por grupos de causas segundo <a href = https://bvsms.saude.gov.br/bvs/publicacoes/demografia_saude_contribuicao_tendencias.pdf , target = _blank>França e Lansky (2009)</a> &nbsp;</b>")
              ),
              hr(),
              fluidRow(
                column(
                ...
                column(
                  ...
                  tags$div(
                    ...
                    checkboxGroupInput(
                      ...
                      selected = c("antes", "sem_info_parto", "durante")
                    )
                  )
                ),
                column(
              ...
              shinycssloaders::withSpinner(highcharter::highchartOutput(ns("plot_causas_principais"), height = 420))
            )
          ),
          column(
            width = 12,
            bs4Dash::bs4Card(
              ...
              div(
                style = "height: 7%; display: flex; align-items: center;",
                HTML("<b class = 'fonte-muito-grande'> Distribuição percentual dos óbitos fetais segundo análise de evitabilidade baseada em <a href = 'https://www.scielo.br/j/csp/a/Rf4nPNxMhWxBzgznsc86Cmd/?format=html&lang=pt' target = _blank>Fonseca, S.C. et al (2021)</a> &nbsp;</b>")),
              hr(),
              fluidRow(
                column(
                  width = 12,
              ...
              shinycssloaders::withSpinner(highcharter::highchartOutput(ns("plot_causas_evitaveis"), height = 420))
            )
          )
        )
      )
...
#' bloco_7_fetal Server Functions
#'
#' @noRd
mod_bloco_7_fetal_server <- function(id, filtros){
  moduleServer(id, function(input, output, session){
    ...
    cols_num_obitos_taxa <- function(input) {
      list(
        tot = sprintf("obitos_fetais_%s_%s", input$input_num_obitos_peso, input$input_num_obitos_momento),
        num_taxa = sprintf("obitos_fetais_%s_%s", input$input_taxa_de_mortalidade_peso, input$input_taxa_de_mortalidade_momento),
    ...
    indicadores_distribuicao_momento <- function(s) {
      ...
      porc_sem_mom <- round(100 - (porc_antes + porc_durante), 1)
      data.table::as.data.table(list(
    ...
    bloco7_fetal_localidade <- reactive(filtra_localidade(bloco7_fetal, filtros()))
    bloco7_fetal_comp <- reactive(filtra_localidade(bloco7_fetal, filtros(), comp = TRUE))
    bloco7_fetal_referencia <- reactive(filtra_localidade(bloco7_fetal, filtros(), referencia = TRUE))
    ...
    dfs_localidade_obitos <- reactive({
      validate(
        need(
          ...
          "⚠ Não existem ocorrências de óbitos fetais para os filtros selecionados."
        )
      )
      processa_bloco7(bloco7_fetal_localidade(), input, filtros(), cols_num_obitos_taxa, indicadores_num_obitos_taxa)
    })
    ...
    dfs_localidade_distribuicao_peso <- reactive({
      ...
      processa_bloco7(bloco7_fetal_localidade(), input, filtros(), cols_distribuicao_peso, indicadores_distribuicao_peso)
    })
    ...
    dfs_localidade_distribuicao_momento <- reactive({
      ...
      processa_bloco7(bloco7_fetal_localidade(), input, filtros(), cols_distribuicao_momento, indicadores_distribuicao_momento)
    })
    ...
    dfs_localidade_evitaveis <- reactive({
      ...
      processa_causas(bloco7_evitaveis_fetal, filtros(), pesos = input$input_evitaveis_peso, momentos = input$input_evitaveis_momento, grupos = input$input_evitaveis_grupos, prefixo_coluna = "evitaveis_fetal")
    })
    ...
    dfs_localidade_principais <- reactive({
      ...
      processa_causas(bloco7_principais_fetal, filtros(), pesos = input$input_principais_peso, momentos = input$input_principais_momento, grupos = input$input_principais_grupos, prefixo_coluna = "principais_fetal")
    })

    ### Criando dataframes separados para o resumo
    data7_resumo_localidade_num_obitos <- eventReactive(c(filtros()$pesquisar, input$input_num_obitos_peso, input$input_num_obitos_momento), {
      dfs_localidade_obitos()$resumo
    }, ignoreNULL = FALSE)

    data7_resumo_localidade_taxa_de_mortalidade <- eventReactive(c(filtros()$pesquisar, input$input_taxa_de_mortalidade_peso, input$input_taxa_de_mortalidade_momento), {
    ...
    data7_num_obitos <- eventReactive(c(filtros()$pesquisar, input$input_num_obitos_peso, input$input_num_obitos_momento), {
      dfs_localidade_obitos()$graficos |>
        dplyr::mutate(class = ifelse(class == "Brasil (valor de referência)", "Brasil", class))
    }, ignoreNULL = FALSE)

    data7_taxa_de_mortalidade <- eventReactive(c(filtros()$pesquisar, input$input_taxa_de_mortalidade_peso, input$input_taxa_de_mortalidade_momento), {
    ...
    dfs_comp_obitos <- reactive({
      ...
      processa_bloco7(bloco7_fetal_comp(), input, filtros(), comp = TRUE, cols_num_obitos_taxa, indicadores_num_obitos_taxa)
    })
    ...
    dfs_comp_distribuicao_peso <- reactive({
      ...
      processa_bloco7(bloco7_fetal_comp(), input, filtros(), comp = TRUE, cols_distribuicao_peso, indicadores_distribuicao_peso)
    })
    ...
    dfs_comp_distribuicao_momento <- reactive({
      ...
      processa_bloco7(bloco7_fetal_comp(), input, filtros(), comp = TRUE, cols_distribuicao_momento, indicadores_distribuicao_momento)
    })
    ...
    dfs_comp_evitaveis <- reactive({
      ...
      processa_causas(bloco7_evitaveis_fetal, filtros(), comp = TRUE, pesos = input$input_evitaveis_peso, momentos = input$input_evitaveis_momento, grupos = input$input_evitaveis_grupos, prefixo_coluna = "evitaveis_fetal")
    })
    ...
    dfs_comp_principais <- reactive({
      ...
      processa_causas(bloco7_principais_fetal, filtros(), comp = TRUE, pesos = input$input_principais_peso, momentos = input$input_principais_momento, grupos = input$input_principais_grupos, prefixo_coluna = "principais_fetal")
    })

    ### Criando dataframes separados para o resumo
    data7_resumo_comp_num_obitos <- eventReactive(c(filtros()$pesquisar, input$input_num_obitos_peso, input$input_num_obitos_momento), {
      dfs_comp_obitos()$resumo
    }, ignoreNULL = FALSE)

    data7_resumo_comp_taxa_de_mortalidade <- eventReactive(c(filtros()$pesquisar, input$input_taxa_de_mortalidade_peso, input$input_taxa_de_mortalidade_momento), {
    ...
    ### Criando dataframes separados para os gráficos
    data7_comp_num_obitos <- eventReactive(c(filtros()$pesquisar, input$input_num_obitos_peso, input$input_num_obitos_momento), {
      dfs_comp_obitos()$graficos |>
        dplyr::mutate(class = ifelse(class == "Brasil (valor de referência)", "Brasil", class))
    }, ignoreNULL = FALSE)

    data7_comp_taxa_de_mortalidade <- eventReactive(c(filtros()$pesquisar, input$input_taxa_de_mortalidade_peso, input$input_taxa_de_mortalidade_momento), {
    ...
    dfs_referencia_obitos <- reactive({
      ...
      processa_bloco7(bloco7_fetal_referencia(), input, filtros(), referencia = TRUE, cols_num_obitos_taxa, indicadores_num_obitos_taxa)
    })
    ...
    dfs_referencia_distribuicao_peso <- reactive({
      ...
      processa_bloco7(bloco7_fetal_referencia(), input, filtros(), referencia = TRUE, cols_distribuicao_peso, indicadores_distribuicao_peso)
    })
    ...
    dfs_referencia_distribuicao_momento <- reactive({
      ...
      processa_bloco7(bloco7_fetal_referencia(), input, filtros(), referencia = TRUE, cols_distribuicao_momento, indicadores_distribuicao_momento)
    })
    ...
    dfs_referencia_evitaveis <- reactive({
      ...
      processa_causas(bloco7_evitaveis_fetal, filtros(), referencia = TRUE, pesos = input$input_evitaveis_peso, momentos = input$input_evitaveis_momento, grupos = input$input_evitaveis_grupos, prefixo_coluna = "evitaveis_fetal")
    })
    ...
    dfs_referencia_principais <- reactive({
      ...
      processa_causas(bloco7_principais_fetal, filtros(), referencia = TRUE, pesos = input$input_principais_peso, momentos = input$input_principais_momento, grupos = input$input_principais_grupos, prefixo_coluna = "principais_fetal")
    })

    ### Criando dataframes separados para o resumo
    data7_resumo_referencia_num_obitos <- eventReactive(c(filtros()$pesquisar, input$input_num_obitos_peso, input$input_num_obitos_momento), {
      dfs_referencia_obitos()$resumo
    }, ignoreNULL = FALSE)

    referencia_oms <- reactive(ifelse(input$input_taxa_de_mortalidade_momento == "todos" & length(input$input_taxa_de_mortalidade_peso) == 5, TRUE, FALSE))

    data7_resumo_referencia_taxa_de_mortalidade <- eventReactive(c(filtros()$pesquisar, input$input_taxa_de_mortalidade_peso, input$input_taxa_de_mortalidade_momento), {
    ...
    data7_referencia_taxa_de_mortalidade <- eventReactive(c(filtros()$pesquisar, input$input_taxa_de_mortalidade_peso, input$input_taxa_de_mortalidade_momento), {
    ...
    observeEvent(c(filtros()$pesquisar, input$localidade_resumo, input$input_num_obitos_peso, input$input_num_obitos_momento), {
      output_pronto_num_obitos(FALSE)  # Reseta
      shinyjs::hide(id = "mostrar_botao_num_obitos", anim = FALSE)
    }, priority = 1)

    #### Criando a caixinha
    output$caixa_b7_fetal_num_obitos <- renderUI({
      output_pronto_num_obitos(TRUE)
      cria_caixa_server(
        dados = data7_resumo_num_obitos(),
        indicador = "obitos_fetais_totais",
        titulo = "Número de óbitos fetais",
        tem_meta = FALSE,
        valor_de_referencia = data7_resumo_referencia_num_obitos()[["obitos_fetais_totais"]],
        tipo = "número",
        invertido = FALSE,
        cor = "lightgrey",
    ...
    #### Escondendo o botão da tooltip antes de começar a renderizar de novo
    observeEvent(c(filtros()$pesquisar, input$localidade_resumo, input$input_taxa_de_mortalidade_peso, input$input_taxa_de_mortalidade_momento), {
      output_pronto_taxa_de_mortalidade(FALSE)  # Reseta
      shinyjs::hide(id = "mostrar_botao_taxa_de_mortalidade", anim = FALSE)
    }, priority = 1)

    #### Criando a caixinha
    output$caixa_b7_fetal_taxa_de_mortalidade <- renderUI({
      output_pronto_taxa_de_mortalidade(TRUE)
      cria_caixa_server(
        dados = data7_resumo_taxa_de_mortalidade(),
        indicador = "taxa_de_mortalidade",
        titulo = "Taxa de mortalidade fetal por 1000 nascidos vivos",
    ...
    #### Criando a caixinha
    output$caixa_b7_fetal_distribuicao_peso <- renderUI({
      ...
      cria_caixa_conjunta_bloco7(
        ...
        titulo = "Dentre os óbitos fetais selecionados,",
        tamanho_caixa = 330,
        retornar_caixa_completa = FALSE
      )
    })
    ...
    #### Criando a caixinha
    output$caixa_b7_fetal_distribuicao_momento <- renderUI({
    ...
    #### Criando a caixinha
    output$caixa_b7_fetal_evitaveis <- renderUI({
    ...
    #### Criando a caixinha
    output$caixa_b7_fetal_principais <- renderUI({
    ...
    output$plot_obitos <- highcharter::renderHighchart({
      grafico_base <- highcharter::highchart() |>
        ...
        highcharter::hc_add_series(
          ...
          type = "line",
          highcharter::hcaes(x = ano, y = obitos_fetais_totais, group = class, colour = class)
        ) |>
    ...
    ## Distribuição percentual do momento do óbito fetal por faixa de peso ----
      ...
      if (filtros()$comparar == "Não") {
        ...
        dplyr::full_join(
          ...
          data7_comp_distribuicao_momento() |>
            ...
            dplyr::rename_with(~paste0("br_", .x), dplyr::contains("porc_obito_fetal")),
          by = "ano"
        ) |>
          dplyr::arrange(dplyr::desc(ano)) |>
          dplyr::mutate(
    ...
    output$plot_distribuicao_momento <- highcharter::renderHighchart({
      highcharter::highchart()|>
        highcharter::hc_add_series(
          ...
          highcharter::hcaes(x = ano, y = porc_obito_fetal_momento_faltante),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_fetal_momento_faltante:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "Durante o parto",
          data = data7_distribuicao_momento_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_fetal_durante),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_fetal_durante:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "Antes do parto",
          data = data7_distribuicao_momento_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_fetal_antes),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_fetal_antes:,f}% </b>"
          )
        ) |>
    ...
    ## Distribuição percentual das faixas de peso por momento do óbito fetal ----
    ...
    output$plot_distribuicao_peso <- highcharter::renderHighchart({
      highcharter::highchart()|>
        highcharter::hc_add_series(
          ...
          highcharter::hcaes(x = ano, y = porc_obito_fetal_peso_faltante),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_fetal_peso_faltante:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "Maior ou igual a 2500g",
          data =  data7_distribuicao_peso_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_fetal_2500_mais),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_fetal_2500_mais:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "De 1500 a 2499g",
          data =  data7_distribuicao_peso_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_fetal_1500_2499),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_fetal_1500_2499:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "De 1000 a 1499g",
          data =  data7_distribuicao_peso_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_fetal_1000_1499),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_fetal_1000_1499:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "Menor que 1000g",
          data =  data7_distribuicao_peso_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_fetal_menos_1000),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_fetal_menos_1000:,f}% </b>"
          )
        ) |>
        highcharter::hc_legend(reversed = TRUE) |>
        highcharter::hc_plotOptions(series = list(stacking = "percent")) |>
...
# mod_bloco_7_fetal_ui("bloco_7_fetal_1")

## To be copied in the server
# mod_bloco_7_fetal_server("bloco_7_fetal_1")
