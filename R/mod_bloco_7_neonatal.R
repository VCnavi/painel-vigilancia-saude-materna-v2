...
mod_bloco_7_neonatal_ui <- function(id) {
  ns <- NS(id)
  tagList(
    tags$style(
      HTML(
      ...
      column(
        ...
        fluidRow(
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_neonatal_num_obitos"),
              ...
              div(
                ...
                htmltools::tagList(
                  HTML("<b> Número de óbitos neonatais&nbsp;</b>"),
                  shinyjs::hidden(
                    span(
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_neonatal_num_obitos")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_neonatal_taxa_de_mortalidade"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              div(
                ...
                style = glue::glue("height: 31%; padding: 0 10px; position: absolute; z-index: 2; color: transparent;"),
                htmltools::tagList(
                  HTML("<b> Taxa de mortalidade neonatal&nbsp;</b>"),
                  shinyjs::hidden(
                    span(
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_neonatal_taxa_de_mortalidade")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_neonatal_taxa_de_mortalidade_precoce"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              div(
                ...
                style = glue::glue("height: 31%; padding: 0 10px; position: absolute; z-index: 2; color: transparent;"),
                htmltools::tagList(
                  HTML("<b> Taxa de mortalidade neonatal com idade 0 a 6 dias por 1000 nascidos vivos&nbsp;</b>"),
                  shinyjs::hidden(
                    span(
                      id = ns("mostrar_botao_taxa_de_mortalidade_precoce"),
                      actionButton(
                        inputId = ns("info_btn_taxa_de_mortalidade_precoce"),
                        label = NULL,
                        icon = icon("info-circle", class = "info-icon"),
                        class = "btn btn-sm btn-no-style info-btn fonte-media"
                      )
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_neonatal_taxa_de_mortalidade_precoce")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_neonatal_taxa_de_mortalidade_tardia"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              div(
                ...
                style = glue::glue("height: 31%; padding: 0 10px; position: absolute; z-index: 2; color: transparent;"),
                htmltools::tagList(
                  HTML("<b> Taxa de mortalidade neonatal com idade 7 a 27 dias por 1000 nascidos vivos&nbsp;</b>"),
                  shinyjs::hidden(
                    span(
                      id = ns("mostrar_botao_taxa_de_mortalidade_tardia"),
                      actionButton(
                        inputId = ns("info_btn_taxa_de_mortalidade_tardia"),
                        label = NULL,
                        icon = icon("info-circle", class = "info-icon"),
                        class = "btn btn-sm btn-no-style info-btn fonte-media"
                      )
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_neonatal_taxa_de_mortalidade_tardia")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_neonatal_distribuicao_momento"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              div(
                ...
                htmltools::tagList(
                  HTML("<b> Dentre os óbitos neonatais selecionados,&nbsp;</b>"),
                  shinyjs::hidden(
                    span(
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_neonatal_distribuicao_momento")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_neonatal_distribuicao_peso"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_neonatal_distribuicao_peso")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_neonatal_principais"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_neonatal_principais")), proxy.height = "276px")
            )
          ),
          column(
            width = 6,
            bs4Dash::box(
              id = ns("caixa_b7_neonatal_evitaveis"),
              style = "height: 330px; overflow: visible; padding: 0;",
              width = 12,
              collapsible = FALSE,
              headerBorder = FALSE,
              div(
                ...
                style = glue::glue("height: 31%; padding: 0 10px; position: absolute; z-index: 2; color: transparent;"),
                htmltools::tagList(
                  HTML("<b> Porcentagem de óbitos neonatais potencialmente evitáveis&nbsp;</b>"),
                  shinyjs::hidden(
                    span(
              ...
              shinycssloaders::withSpinner(uiOutput(ns("caixa_b7_neonatal_evitaveis")), proxy.height = "276px")
            )
          )
        )
      ),
            ...
            bs4Dash::bs4Card(
              ...
              fluidRow(
                column(
                  width = 12,
                  shinyWidgets::pickerInput(
                    inputId = ns("input_taxa_de_mortalidade_precoce_peso"),
                    label = span(class = "fonte-grande", "Faixas de peso"),
                    options = list(placeholder = "Selecione, aqui, as faixas de interesse", `actions-box` = TRUE, `deselect-all-text` = "Desselecionar todas", `select-all-text` = "Selecionar todas", `none-selected-text` = "Nenhuma opção selecionada"),
                    choices = c(
                      "Menor que 1000 g" = "menos_1000",
              ...
              shinycssloaders::withSpinner(highcharter::highchartOutput(ns("plot_taxa_de_mortalidade_precoce"), height = 380))
            )
          ),
          column(
            width = 6,
            bs4Dash::bs4Card(
              ...
              fluidRow(
                column(
                  width = 12,
                  shinyWidgets::pickerInput(
                    inputId = ns("input_taxa_de_mortalidade_tardia_peso"),
                    label = span(class = "fonte-grande", "Faixas de peso"),
                    options = list(placeholder = "Selecione, aqui, as faixas de interesse", `actions-box` = TRUE, `deselect-all-text` = "Desselecionar todas", `select-all-text` = "Selecionar todas", `none-selected-text` = "Nenhuma opção selecionada"),
                    choices = c(
                      "Menor que 1000 g" = "menos_1000",
              ...
              shinycssloaders::withSpinner(highcharter::highchartOutput(ns("plot_taxa_de_mortalidade_tardia"), height = 380))
            )
          ),
          column(
            width = 6,
...
#' bloco_7_neonatal Server Functions
#'
#' @noRd
mod_bloco_7_neonatal_server <- function(id, filtros){
  moduleServer(id, function(input, output, session){
    ...
    cols_num_obitos_taxa <- function(input) {
      list(
        tot = sprintf("obitos_neonatais_%s_todos", input$input_num_obitos_peso),
        num_taxa_total = sprintf("obitos_neonatais_%s_todos", input$input_taxa_de_mortalidade_peso),
        den_taxa_total = sprintf("nv_peso_%s", input$input_taxa_de_mortalidade_peso),
        num_taxa_precoce = sprintf("obitos_neonatais_%s_0_a_6_dias", input$input_taxa_de_mortalidade_precoce_peso),
        den_taxa_precoce = sprintf("nv_peso_%s", input$input_taxa_de_mortalidade_precoce_peso),
        num_taxa_tardia = sprintf("obitos_neonatais_%s_7_a_27_dias", input$input_taxa_de_mortalidade_tardia_peso),
        den_taxa_tardia = sprintf("nv_peso_%s", input$input_taxa_de_mortalidade_tardia_peso)
      )
    }

    indicadores_num_obitos_taxa <- function(s) {
      taxa_total <- round(s$num_taxa_total / (s$num_taxa_total + s$den_taxa_total) * 1000, 1)
      taxa_precoce <- round(s$num_taxa_precoce / (s$num_taxa_precoce + s$den_taxa_precoce) * 1000, 1)
      taxa_tardia <- round(s$num_taxa_tardia / (s$num_taxa_tardia + s$den_taxa_tardia) * 1000, 1)
      data.table::as.data.table(list(
        obitos_neonatais_totais = s$tot,
        taxa_de_mortalidade = taxa_total,
        taxa_de_mortalidade_precoce = taxa_precoce,
        taxa_de_mortalidade_tardia = taxa_tardia
      ))
    }
    ...
    cols_distribuicao_peso <- function(input) {
      list(
        p_m1000 = sprintf("obitos_neonatais_menos_1000_%s", input$input_distribuicao_momento),
        p_1k15 = sprintf("obitos_neonatais_1000_1499_%s", input$input_distribuicao_momento),
        p_15k25 = sprintf("obitos_neonatais_1500_2499_%s", input$input_distribuicao_momento),
        p_25mais = sprintf("obitos_neonatais_2500_mais_%s", input$input_distribuicao_momento),
        p_todos = sprintf("obitos_neonatais_todos_%s", input$input_distribuicao_momento)
      )
    }
    ...
    indicadores_distribuicao_peso <- function(s) {
      ...
      data.table::as.data.table(list(
        porc_obito_neonatal_menos_1000 = porc_m1000,
        porc_obito_neonatal_1000_1499 = porc_1k15,
        porc_obito_neonatal_1500_2499 = porc_15k25,
        porc_obito_neonatal_2500_mais = porc_25mais,
        porc_obito_neonatal_peso_faltante = porc_sem_peso
      ))
    }
    ...
    cols_distribuicao_momento <- function(input) {
      list(
        dia_0 = sprintf("obitos_neonatais_%s_0_dias", input$input_distribuicao_peso),
        dia_1_a_6 = sprintf("obitos_neonatais_%s_1_a_6_dias", input$input_distribuicao_peso),
        dia_7_a_27 = sprintf("obitos_neonatais_%s_7_a_27_dias", input$input_distribuicao_peso),
        todos = sprintf("obitos_neonatais_%s_todos", input$input_distribuicao_peso)
      )
    }
    ...
    indicadores_distribuicao_momento <- function(s) {
      ...
      porc_7_a_27_dias <- round(s$dia_7_a_27 / s$todos * 100, 1)
      porc_sem_mom <- round(100 - (porc_0_dias + porc_1_a_6_dias + porc_7_a_27_dias), 1)
      data.table::as.data.table(list(
        porc_obito_neonatal_0_dias = porc_0_dias,
        porc_obito_neonatal_1_a_6_dias = porc_1_a_6_dias,
        porc_obito_neonatal_7_a_27_dias = porc_7_a_27_dias,
        porc_obito_neonatal_momento_faltante = porc_sem_mom
      ))
    }


    ## Pré-filtrando os dados da localidade, comparação e refeência ------------
    bloco7_neonatal_localidade <- reactive(filtra_localidade(bloco7_neonatal, filtros()))
    bloco7_neonatal_comp <- reactive(filtra_localidade(bloco7_neonatal, filtros(), comp = TRUE))
    bloco7_neonatal_referencia <- reactive(filtra_localidade(bloco7_neonatal, filtros(), referencia = TRUE))
    ...
    referencia_oms_precoce <- reactive(ifelse(length(input$input_taxa_de_mortalidade_precoce_peso) == 5, TRUE, FALSE))
    ...
    data7_resumo_taxa_de_mortalidade_precoce <- reactive(escolhe_resumo(filtros()$comparar, input$localidade_resumo, data7_resumo_localidade_taxa_de_mortalidade_precoce(), data7_resumo_comp_taxa_de_mortalidade_precoce()))
    data7_resumo_taxa_de_mortalidade_tardia <- reactive(escolhe_resumo(filtros()$comparar, input$localidade_resumo, data7_resumo_localidade_taxa_de_mortalidade_tardia(), data7_resumo_comp_taxa_de_mortalidade_tardia()))
    ...
    #### Criando a caixinha
    output$caixa_b7_neonatal_num_obitos <- renderUI({
      output_pronto_num_obitos(TRUE)
      cria_caixa_server(
        dados = data7_resumo_num_obitos(),
        indicador = "obitos_neonatais_totais",
        titulo = "Número de óbitos neonatais",
        tem_meta = FALSE,
        valor_de_referencia = data7_resumo_referencia_num_obitos()[["obitos_neonatais_totais"]],
        tipo = "número",
        invertido = FALSE,
        cor = "lightgrey",
    ...
    #### Criando a caixinha
    output$caixa_b7_neonatal_taxa_de_mortalidade <- renderUI({
    ...
    output_pronto_taxa_de_mortalidade_precoce <- reactiveVal(FALSE)

    #### Escondendo o botão da tooltip antes de começar a renderizar de novo
    observeEvent(c(filtros()$pesquisar, input$localidade_resumo, input$input_taxa_de_mortalidade_precoce_peso), {
      output_pronto_taxa_de_mortalidade_precoce(FALSE)  # Reseta
      shinyjs::hide(id = "mostrar_botao_taxa_de_mortalidade_precoce", anim = FALSE)
    }, priority = 1)

    #### Criando a caixinha
    output$caixa_b7_neonatal_taxa_de_mortalidade_precoce <- renderUI({
      output_pronto_taxa_de_mortalidade_precoce(TRUE)
      cria_caixa_server(
        ...
        valor_de_referencia = ifelse(
          data7_resumo_referencia_taxa_de_mortalidade_precoce()[["taxa_de_mortalidade_precoce"]] > 0,
          data7_resumo_referencia_taxa_de_mortalidade_precoce()[["taxa_de_mortalidade_precoce"]],
          NaN
        ),
        tipo = "taxa",
        invertido = FALSE,
    ...
    output_pronto_taxa_de_mortalidade_tardia <- reactiveVal(FALSE)

    #### Escondendo o botão da tooltip antes de começar a renderizar de novo
    observeEvent(c(filtros()$pesquisar, input$localidade_resumo, input$input_taxa_de_mortalidade_tardia_peso), {
      output_pronto_taxa_de_mortalidade_tardia(FALSE)  # Reseta
      shinyjs::hide(id = "mostrar_botao_taxa_de_mortalidade_tardia", anim = FALSE)
    }, priority = 1)

    #### Criando a caixinha
    output$caixa_b7_neonatal_taxa_de_mortalidade_tardia <- renderUI({
      output_pronto_taxa_de_mortalidade_tardia(TRUE)
      cria_caixa_server(
        ...
        valor_de_referencia = ifelse(
          data7_resumo_referencia_taxa_de_mortalidade_tardia()[["taxa_de_mortalidade_tardia"]] > 0,
          data7_resumo_referencia_taxa_de_mortalidade_tardia()[["taxa_de_mortalidade_tardia"]],
          NaN
        ),
        tipo = "taxa",
        invertido = FALSE,
    ...
    #### Criando a caixinha
    output$caixa_b7_neonatal_distribuicao_peso <- renderUI({
    ...
    #### Criando a caixinha
    output$caixa_b7_neonatal_distribuicao_momento <- renderUI({
    ...
    #### Criando a caixinha
    output$caixa_b7_neonatal_evitaveis <- renderUI({
    ...
    #### Criando a caixinha
    output$caixa_b7_neonatal_principais <- renderUI({
    ...
    output$plot_obitos <- highcharter::renderHighchart({
      grafico_base <- highcharter::highchart() |>
        ...
        highcharter::hc_add_series(
          ...
          type = "line",
          highcharter::hcaes(x = ano, y = obitos_neonatais_totais, group = class, colour = class)
        ) |>
    ...
    ## Taxa de mortalidade neonatal com idade de 0 a 6 dias por 1000 nascidos vivos -----
    output$plot_taxa_de_mortalidade_precoce <- highcharter::renderHighchart({
      grafico_base <- highcharter::highchart() |>
        highcharter::hc_add_dependency("modules/series-label.js") |>
        highcharter::hc_add_series(
          data = data7_taxa_de_mortalidade_precoce(),
          type = "line",
          name = ifelse(referencia_oms_precoce() == FALSE, data7_taxa_de_mortalidade_precoce()$class, gsub(" \\(valor de referência\\)", "", data7_taxa_de_mortalidade_precoce()$class)),
          highcharter::hcaes(x = ano, y = taxa_de_mortalidade_precoce, group = class, colour = class)
        ) |>
        highcharter::hc_plotOptions(
          series = list(
            label = list(enabled = TRUE),
      ...
      if ((any(c(filtros()$nivel, filtros()$nivel2) == "nacional") & referencia_oms() == FALSE) | (filtros()$mostrar_referencia == "nao_mostrar_referencia")) {
        ...
        grafico_base <- grafico_base |>
          highcharter::hc_add_series(
            data = data7_referencia_taxa_de_mortalidade_precoce(),
            type = "line",
            name = ifelse(referencia_oms_precoce() == FALSE, "Referência (média nacional)", "Referência (meta ODS)"),
            highcharter::hcaes(x = ano, y = taxa_de_mortalidade_precoce, group = class, colour = class),
            dashStyle = "ShortDot",
            opacity = 0.7
          )
      ...
      if (filtros()$comparar == "Não") {
        ...
        grafico_base <- grafico_base |>
          highcharter::hc_add_series(
            data = data7_comp_taxa_de_mortalidade_precoce(),
            type = "line",
            name = ifelse(referencia_oms_precoce() == FALSE, data7_comp_taxa_de_mortalidade_precoce()$class, gsub(" \\(valor de referência\\)", "", data7_comp_taxa_de_mortalidade_precoce()$class)),
            highcharter::hcaes(x = ano, y = taxa_de_mortalidade_precoce, group = class, colour = class)
          )
      }
    })

    ## Taxa de mortalidade neonatal com idade de 7 a 27 dias por 1000 nascidos vivos -----
    output$plot_taxa_de_mortalidade_tardia <- highcharter::renderHighchart({
      grafico_base <- highcharter::highchart() |>
        highcharter::hc_add_dependency("modules/series-label.js") |>
        highcharter::hc_add_series(
          data = data7_taxa_de_mortalidade_tardia(),
          type = "line",
          name = ifelse(referencia_oms_tardia() == FALSE, data7_taxa_de_mortalidade_tardia()$class, gsub(" \\(valor de referência\\)", "", data7_taxa_de_mortalidade_tardia()$class)),
          highcharter::hcaes(x = ano, y = taxa_de_mortalidade_tardia, group = class, colour = class)
        ) |>
        highcharter::hc_plotOptions(
          series = list(
            label = list(enabled = TRUE),
      ...
      if ((any(c(filtros()$nivel, filtros()$nivel2) == "nacional") & referencia_oms() == FALSE) | (filtros()$mostrar_referencia == "nao_mostrar_referencia")) {
        ...
        grafico_base <- grafico_base |>
          highcharter::hc_add_series(
            data = data7_referencia_taxa_de_mortalidade_tardia(),
            type = "line",
            name = ifelse(referencia_oms_tardia() == FALSE, "Referência (média nacional)", "Referência (meta ODS)"),
            highcharter::hcaes(x = ano, y = taxa_de_mortalidade_tardia, group = class, colour = class),
            dashStyle = "ShortDot",
            opacity = 0.7
          )
      ...
      if (filtros()$comparar == "Não") {
        ...
        grafico_base <- grafico_base |>
          highcharter::hc_add_series(
            data = data7_comp_taxa_de_mortalidade_tardia(),
            type = "line",
            name = ifelse(referencia_oms_tardia() == FALSE, data7_comp_taxa_de_mortalidade_tardia()$class, gsub(" \\(valor de referência\\)", "", data7_comp_taxa_de_mortalidade_tardia()$class)),
            highcharter::hcaes(x = ano, y = taxa_de_mortalidade_tardia, group = class, colour = class)
          )
      }
    })

    ## Distribuição percentual do momento do óbito neonatal por faixa de peso ----
      ...
      if (filtros()$comparar == "Não") {
        ...
        dplyr::full_join(
          ...
          data7_comp_distribuicao_momento() |>
            ...
            dplyr::rename_with(~paste0("br_", .x), dplyr::contains("porc_obito_neonatal")),
          by = "ano"
        ) |>
          dplyr::arrange(dplyr::desc(ano)) |>
          dplyr::mutate(
    ...
    output$plot_distribuicao_momento <- highcharter::renderHighchart({
      highcharter::highchart()|>
        highcharter::hc_add_series(
          ...
          highcharter::hcaes(x = ano, y = porc_obito_neonatal_momento_faltante),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_neonatal_momento_faltante:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "De 7 a 27 dias de vida",
          data =  data7_distribuicao_momento_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_neonatal_7_a_27_dias),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_neonatal_7_a_27_dias:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "De 1 a 6 dias de vida",
          data =  data7_distribuicao_momento_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_neonatal_1_a_6_dias),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
        ...
        highcharter::hc_add_series(
          name = "Dia 0 de vida",
          data =  data7_distribuicao_momento_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_neonatal_0_dias),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
    ...
    ## Distribuição percentual das faixas de peso por momento do óbito neonatal ----
    ...
    output$plot_distribuicao_peso <- highcharter::renderHighchart({
      highcharter::highchart()|>
        highcharter::hc_add_series(
          ...
          highcharter::hcaes(x = ano, y = porc_obito_neonatal_peso_faltante),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_neonatal_peso_faltante:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "Maior ou igual a 2500g",
          data =  data7_distribuicao_peso_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_neonatal_2500_mais),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_neonatal_2500_mais:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "De 1500 a 2499g",
          data =  data7_distribuicao_peso_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_neonatal_1500_2499),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_neonatal_1500_2499:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "De 1000 a 1499g",
          data =  data7_distribuicao_peso_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_neonatal_1000_1499),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_neonatal_1000_1499:,f}% </b>"
          )
        ) |>
        highcharter::hc_add_series(
          name = "Menor que 1000g",
          data =  data7_distribuicao_peso_juncao(),
          highcharter::hcaes(x = ano, y = porc_obito_neonatal_menos_1000),
          type = "bar",
          showInLegend = TRUE,
          tooltip = list(
            pointFormat = "<span style = 'color: {series.color}'> &#9679 </span> {series.name} <b>({point.class})</b>: <b> {point.y}% </b> <br> {point.localidade_comparacao}: <b> {point.br_porc_obito_neonatal_menos_1000:,f}% </b>"
          )
        ) |>
        highcharter::hc_legend(reversed = TRUE) |>
        highcharter::hc_plotOptions(series = list(stacking = "percent")) |>
...
# mod_bloco_7_neonatal_ui("bloco_7_neonatal_1")

## To be copied in the server
# mod_bloco_7_neonatal_server("bloco_7_neonatal_1")
