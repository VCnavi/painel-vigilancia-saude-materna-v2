          ...
          column(
            ...
            bs4Dash::bs4Card(
              ...
              div(
                ...
                HTML("<b class = 'fonte-muito-grande'> Distribuição percentual dos óbitos perinatais por grupos de causas segundo <a href = https://bvsms.saude.gov.br/bvs/publicacoes/demografia_saude_contribuicao_tendencias.pdf , target = _blank>França e Lansky (2009)</a> &nbsp;</b>")
              ),
              hr(),
              fluidRow(
                column(
...
mod_bloco_7_perinatal_server <- function(id, filtros){
  moduleServer(id, function(input, output, session){
    ...
    dfs_localidade_obitos <- reactive({
      validate(
        need(
          ...
          "⚠ Não existem ocorrências de óbitos perinatais para os filtros selecionados."
        )
      )
      processa_bloco7(bloco7_perinatal_localidade(), input, filtros(), cols_num_obitos_taxa, indicadores_num_obitos_taxa)
    })
    ...
    dfs_localidade_distribuicao_peso <- reactive({
      ...
      processa_bloco7(bloco7_perinatal_localidade(), input, filtros(), cols_distribuicao_peso, indicadores_distribuicao_peso)
    })
    ...
    dfs_localidade_distribuicao_momento <- reactive({
      ...
      processa_bloco7(bloco7_perinatal_localidade(), input, filtros(), cols_distribuicao_momento, indicadores_distribuicao_momento)
    })
    ...
    dfs_localidade_evitaveis <- reactive({
      ...
      processa_causas(bloco7_evitaveis_perinatal, filtros(), pesos = input$input_evitaveis_peso, momentos = input$input_evitaveis_momento, grupos = input$input_evitaveis_grupos, prefixo_coluna = "evitaveis_perinatal")
    })
    ...
    dfs_localidade_principais <- reactive({
      ...
      processa_causas(bloco7_principais_perinatal, filtros(), pesos = input$input_principais_peso, momentos = input$input_principais_momento, grupos = input$input_principais_grupos, prefixo_coluna = "principais_perinatal")
    })
    ...
    dfs_comp_obitos <- reactive({
      ...
      processa_bloco7(bloco7_perinatal_comp(), input, filtros(), comp = TRUE, cols_num_obitos_taxa, indicadores_num_obitos_taxa)
    })
    ...
    dfs_comp_distribuicao_peso <- reactive({
      ...
      processa_bloco7(bloco7_perinatal_comp(), input, filtros(), comp = TRUE, cols_distribuicao_peso, indicadores_distribuicao_peso)
    })
    ...
    dfs_comp_distribuicao_momento <- reactive({
      ...
      processa_bloco7(bloco7_perinatal_comp(), input, filtros(), comp = TRUE, cols_distribuicao_momento, indicadores_distribuicao_momento)
    })
    ...
    dfs_comp_evitaveis <- reactive({
      ...
      processa_causas(bloco7_evitaveis_perinatal, filtros(), comp = TRUE, pesos = input$input_evitaveis_peso, momentos = input$input_evitaveis_momento, grupos = input$input_evitaveis_grupos, prefixo_coluna = "evitaveis_perinatal")
    })
    ...
    dfs_comp_principais <- reactive({
      ...
      processa_causas(bloco7_principais_perinatal, filtros(), comp = TRUE, pesos = input$input_principais_peso, momentos = input$input_principais_momento, grupos = input$input_principais_grupos, prefixo_coluna = "principais_perinatal")
    })
    ...
    dfs_referencia_obitos <- reactive({
      ...
      processa_bloco7(bloco7_perinatal_referencia(), input, filtros(), referencia = TRUE, cols_num_obitos_taxa, indicadores_num_obitos_taxa)
    })
    ...
    dfs_referencia_distribuicao_peso <- reactive({
      ...
      processa_bloco7(bloco7_perinatal_referencia(), input, filtros(), referencia = TRUE, cols_distribuicao_peso, indicadores_distribuicao_peso)
    })
    ...
    dfs_referencia_distribuicao_momento <- reactive({
      ...
      processa_bloco7(bloco7_perinatal_referencia(), input, filtros(), referencia = TRUE, cols_distribuicao_momento, indicadores_distribuicao_momento)
    })
    ...
    dfs_referencia_evitaveis <- reactive({
      ...
      processa_causas(bloco7_evitaveis_perinatal, filtros(), referencia = TRUE, pesos = input$input_evitaveis_peso, momentos = input$input_evitaveis_momento, grupos = input$input_evitaveis_grupos, prefixo_coluna = "evitaveis_perinatal")
    })
    ...
    dfs_referencia_principais <- reactive({
      ...
      processa_causas(bloco7_principais_perinatal, filtros(), referencia = TRUE, pesos = input$input_principais_peso, momentos = input$input_principais_momento, grupos = input$input_principais_grupos, prefixo_coluna = "principais_perinatal")
    })
