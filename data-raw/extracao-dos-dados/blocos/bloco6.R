...
df_sim_2024 <- fread("https://s3.sa-east-1.amazonaws.com/ckan.saude.gov.br/SIM/csv/DO25OPEN_csv.zip") |>
...
## Exportando os dados
write.csv(df_bloco6_mortalidade, 'data-raw/csv/indicadores_bloco6_mortalidade_materna_2023-2025.csv', row.names = FALSE)
...
rmm_corrigida_2009_2024 <- read_excel("data-raw/extracao-dos-dados/blocos/databases_auxiliares/rmm_corrigida_2009-2024.xlsx") |>
  select(c(localidade = Localidade,
           `2012`, `2013`, `2014`, `2015`, `2016`, `2017`, `2018`, `2019`, `2020`, `2021`, `2022`,
           `2023`, `2024`))

rmm_corrigida_long <- pivot_longer(
  data = rmm_corrigida_2009_2024,
  names_to = "ano",
  values_to = "RMM",
...
write.table(rmm_corrigida_long, 'data-raw/csv/rmm_corrigida_2012-2024.csv', sep = ",", dec = ".", row.names = FALSE)


# rmm_brasil <- read_excel("data-raw/extracao-dos-dados/blocos/databases_auxiliares/analises_obitos_RMM_1996_2021.xlsx") %>%
#   filter(Ano >= 2012)
#
# rmm_regioes <- read_excel("data-raw/extracao-dos-dados/blocos/databases_auxiliares/RMM_Regioes.xlsx") %>%
#   filter(Ano>=2012)
#
# rmm_estados <- read_excel("data-raw/extracao-dos-dados/blocos/databases_auxiliares/RMM_Estados.xlsx") %>%
#   filter(Ano>=2012)
#
